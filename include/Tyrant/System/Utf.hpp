...
public :
    ...
    /// specializations of the TGE::Utf<> template, and allow
...
public :
    ...
    /// of TGE::Utf<>, it is defined for convenience (it is used by
...
///
/// TGE::Utf is a low-level, generic interface for counting, iterating,
...
///
/// TGE::Utf<X> functions are all static, these classes are not meant to
/// be instantiated. All the functions are template, so that you
/// can use any character / string type for a given encoding.
///
/// It has 3 specializations:
/// \li TGE::Utf<8> (typedef'd to TGE::Utf8)
/// \li TGE::Utf<16> (typedef'd to TGE::Utf16)
/// \li TGE::Utf<32> (typedef'd to TGE::Utf32)
///
////////////////////////////////////////////////////////////
