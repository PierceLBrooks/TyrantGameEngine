...
#ifndef TGE_STRING_HPP
#define TGE_STRING_HPP
...
public :
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Create a new TGE::String from a UTF-8 encoded string
    ///
    /// \param begin Forward iterator to the begining of the UTF-8 sequence
    /// \param end   Forward iterator to the end of the UTF-8 sequence
    ///
    /// \return A TGE::String containing the source string
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Create a new TGE::String from a UTF-16 encoded string
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Create a new TGE::String from a UTF-32 encoded string
    ///
    /// This function is provided for consistency, it is equivalent to
    /// using the constructors that takes a const TGE::Uint32* or
    /// a std::basic_string<TGE::Uint32>.
    ///
...
private :
    ...
    friend TGE_API bool operator ==(const String& left, const String& right);
    friend TGE_API bool operator <(const String& left, const String& right);
...
///
////////////////////////////////////////////////////////////
TGE_API bool operator ==(const String& left, const String& right);
...
///
////////////////////////////////////////////////////////////
TGE_API String operator +(const String& left, const String& right);

#include <Tyrant/System/String.inl>

} // namespace TGE


#endif // TGE_STRING_HPP
...
/// \ingroup system
///
/// TGE::String is a utility string class defined mainly for
...
/// s = TGE::String("hello", locale);
/// \endcode
///
/// TGE::String defines the most important functions of the
/// standard std::string class: removing, random access, iterating,
/// appending, comparing, etc. However it is a simple class
/// provided for convenience, and you may have to consider using
/// a more optimized class if your program requires complex string
/// handling. The automatic conversion functions will then take
/// care of converting your string to TGE::String whenever TGE
/// requires it.
///
/// Please note that TGE also defines a low-level, generic
/// interface for Unicode handling, see the TGE::Utf classes.
///
////////////////////////////////////////////////////////////
