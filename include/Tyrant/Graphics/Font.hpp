...
#include <Tyrant/Graphics/Glyph.hpp>
...
public :
    ...
    /// The supported font formats are: TrueType, Type 1, CFF,
    /// OpenType, SFNT, X11 PCF, Windows FNT, BDF, PFR and Type 42.
    /// Warning: TGE cannot preload all the font data in this
...
private :
    ...
    struct Page
    {
        ...
        TGE::Texture      texture; ///< Texture containing the pixels of the glyphs
...
///
/// Once it is loaded, a TGE::Font instance provides three
...
/// use the TGE::Text class, which is able to properly output text
/// with several options such as character size, style, color,
/// position, rotation, etc.
/// This separation allows more flexibility and better performances:
/// indeed a TGE::Font is a heavy resource, and any operation on it
/// is slow (often too slow for real-time applications). On the other
/// side, a TGE::Text is a lightweight object which can combine the
/// glyphs data and metrics of a TGE::Font to display any text on a
/// render target.
/// Note that it is also possible to bind several TGE::Text instances
/// to the same TGE::Font.
///
...
/// text1.setStyle(TGE::Text::Regular);
///
/// // Create another text using the same font, but with different parameters
/// TGE::Text text2;
/// text2.setFont(font);
/// text2.setCharacterSize(50);
/// text1.setStyle(TGE::Text::Italic);
/// \endcode
///
/// Apart from loading font files, and passing them to instances
/// of TGE::Text, you should normally not have to deal directly
