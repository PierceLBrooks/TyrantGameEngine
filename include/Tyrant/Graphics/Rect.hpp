...
#include <Tyrant/Graphics/Rect.inl>
...
/// (Vector2 and Vector3).
///
/// To keep things simple, TGE::Rect doesn't define
/// functions to emulate the properties that are not directly
/// members (such as right, bottom, center, etc.), it rather
/// only provides intersection functions.
///
/// TGE::Rect uses the usual rules for its boundaries:
/// \li The left and top edges are included in the rectangle's area
/// \li The right (left + width) and bottom (top + height) edges are excluded from the rectangle's area
///
/// This means that TGE::IntRect(0, 0, 1, 1) and TGE::IntRect(1, 1, 1, 1)
/// don't intersect.
///
/// TGE::Rect is a template and may be used with any numeric type, but
/// for simplicity the instanciations used by TGE are typedefed:
/// \li TGE::Rect<int> is TGE::IntRect
/// \li TGE::Rect<float> is TGE::FloatRect
///
...
/// TGE::IntRect r1(0, 0, 20, 5);
///
/// // Define another rectangle, located at (4, 2) with a size of 18x10
/// TGE::Vector2i position(4, 2);
/// TGE::Vector2i size(18, 10);
/// TGE::IntRect r2(position, size);
///
