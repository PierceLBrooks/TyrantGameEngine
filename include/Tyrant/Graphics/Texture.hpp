...
#ifndef TGE_TEXTURE_HPP
#define TGE_TEXTURE_HPP
...
///
////////////////////////////////////////////////////////////
class TGE_API Texture : GlResource
{
public :
...
public :
    ...
    ///
    ////////////////////////////////////////////////////////////
    bool loadFromStream(TGE::InputStream& stream, const IntRect& area = IntRect());
    ...
    /// mix TGE::Texture with OpenGL code.
    ///
    /// \code
    /// TGE::Texture t1, t2;
    /// ...
    ...
    /// the graphics classes of TGE, it makes the definition of texture
...
#endif // TGE_TEXTURE_HPP

////////////////////////////////////////////////////////////
/// \class TGE::Texture
/// \ingroup graphics
///
/// TGE::Texture stores pixels that can be drawn, with a sprite
...
/// A texture cannot be manipulated as freely as a TGE::Image,
/// you need to prepare the pixels first and then upload them
/// to the texture in a single operation (see Texture::update).
///
/// TGE::Texture makes it easy to convert from/to TGE::Image, but
...
/// TGE::Image, do whatever you need with the pixels, and then call
...
/// of booleans.
///
/// Like TGE::Image, TGE::Texture can handle a unique internal
/// representation of pixels, which is RGBA 32 bits. This means
/// that a pixel must be composed of 8 bits red, green, blue and
/// alpha channels -- just like a TGE::Color.
///
/// Usage example:
/// \code
/// // This example shows the most common use of TGE::Texture:
/// // drawing a sprite
///
...
///
/// \code
/// // This example shows another common use of TGE::Texture:
...
///
///     // update the texture
///     TGE::Uint8* pixels = ...; // get a fresh chunk of pixels (the next frame of a movie, for example)
...
/// \endcode
///
/// Like TGE::Shader that can be used as a raw OpenGL shader,
/// TGE::Texture can also be used directly as a raw texture for
/// custom OpenGL geometry.
/// \code
/// TGE::Texture::bind(&texture);
/// ... render OpenGL geometry ...
/// TGE::Texture::bind(NULL);
/// \endcode
///
/// \see TGE::Sprite, TGE::Image, TGE::RenderTexture
///
////////////////////////////////////////////////////////////
