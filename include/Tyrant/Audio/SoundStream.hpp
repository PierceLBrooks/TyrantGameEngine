...
#ifndef TGE_SOUNDSTREAM_HPP
#define TGE_SOUNDSTREAM_HPP
...
///
////////////////////////////////////////////////////////////
class TGE_API SoundStream : public SoundSource
{
public :
...
#endif // TGE_SOUNDSTREAM_HPP


////////////////////////////////////////////////////////////
/// \class TGE::SoundStream
/// \ingroup audio
///
/// Unlike audio buffers (see TGE::SoundBuffer), audio streams
...
///
/// TGE::SoundStream is a base class that doesn't care about the
/// stream source, which is left to the derived class. TGE provides
/// a built-in specialization for big files (see TGE::Music).
...
/// Usage example:
/// \code
/// class CustomStream : public TGE::SoundStream
/// {
/// public :
///
