...
#ifndef TGE_SOUND_HPP
#define TGE_SOUND_HPP
...
///
////////////////////////////////////////////////////////////
class TGE_API Sound : public SoundSource
{
public :
    ...
    /// thus the TGE::SoundBuffer instance must remain alive as long
    ...
    /// to use it. It is called by the TGE::SoundBuffer that
...
/// \ingroup audio
///
/// TGE::Sound is the class to use to play sounds.
/// It provides:
...
///
/// TGE::Sound is perfect for playing short sounds that can
/// fit in memory and require no latency, like foot steps or
/// gun shots. For longer sounds, like background musics
/// or long speeches, rather see TGE::Music (which is based
/// on streaming).
///
/// In order to work, a sound must be given a buffer of audio
/// data to play. Audio data (samples) is stored in TGE::SoundBuffer,
