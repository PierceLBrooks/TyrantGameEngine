...
#ifndef TGE_SOUNDRECORDER_HPP
#define TGE_SOUNDRECORDER_HPP
...
public :
    ...
    /// any attempt to use TGE::SoundRecorder or one of its derived
    /// classes will fail.
    ///
...
protected :
    ...
    ///
    ////////////////////////////////////////////////////////////
    void setProcessingInterval(TGE::Time interval);
...
private :
    ...
    TGE::Time           m_processingInterval; ///< Time period between calls to onProcessSamples
...
#endif // TGE_SOUNDRECORDER_HPP


////////////////////////////////////////////////////////////
/// \class TGE::SoundRecorder
/// \ingroup audio
///
/// TGE::SoundBuffer provides a simple interface to access
...
/// TGE provides a built-in specialization for saving the
/// captured data to a sound buffer (see TGE::SoundBufferRecorder).
///
...
/// Usage example:
/// \code
/// class CustomRecorder : public TGE::SoundRecorder
/// {
