...
#ifndef TGE_SOUNDBUFFER_HPP
#define TGE_SOUNDBUFFER_HPP
...
public :
    ...
    /// (TGE::Int16). The total number of samples in this array
...
#endif // TGE_SOUNDBUFFER_HPP


////////////////////////////////////////////////////////////
/// \class TGE::SoundBuffer
/// \ingroup audio
///
...
/// are like texture pixels, and a TGE::SoundBuffer is similar to
/// a TGE::Texture.
///
/// A sound buffer can be loaded from a file (see loadFromFile()
/// for the complete list of supported formats), from memory, from
/// a custom stream (see TGE::InputStream) or directly from an array
/// of samples. It can also be saved back to a file.
///
/// Sound buffers alone are not very useful: they hold the audio data
/// but cannot be played. To do so, you need to use the TGE::Sound class,
...
/// indeed a TGE::SoundBuffer is a heavy resource, and any operation on it
/// is slow (often too slow for real-time applications). On the other
/// side, a TGE::Sound is a lightweight object, which can use the audio data
...
/// several TGE::Sound instances to the same TGE::SoundBuffer.
///
/// It is important to note that the TGE::Sound instance doesn't
/// copy the buffer that it uses, it only keeps a reference to it.
/// Thus, a TGE::SoundBuffer must not be destructed while it is
/// used by a TGE::Sound (i.e. never write a function that
/// uses a local TGE::SoundBuffer instance for loading a sound).
///
/// Usage example:
/// \code
/// // Declare a new sound buffer
/// TGE::SoundBuffer buffer;
///
/// // Load it from a file
...
/// \endcode
///
/// \see TGE::Sound, TGE::SoundBufferRecorder
///
////////////////////////////////////////////////////////////
