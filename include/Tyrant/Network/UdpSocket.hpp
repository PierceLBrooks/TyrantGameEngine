...
#ifndef TGE_UDPSOCKET_HPP
#define TGE_UDPSOCKET_HPP
...
///
////////////////////////////////////////////////////////////
class TGE_API UdpSocket : public Socket
{
public :
...
/// interface uses packets (see TGE::Packet), which are easier
/// to use and provide more safety regarding the data that is
/// exchanged. You can look at the TGE::Packet class to get
...
/// TGE::UdpSocket socket;
/// socket.bind(55001);
///
/// // Send a message to 192.168.1.50 on port 55002
/// std::string message = "Hi, I am " + TGE::IpAddress::getLocalAddress().toString();
/// socket.send(message.c_str(), message.size() + 1, "192.168.1.50", 55002);
///
/// // Receive an answer (most likely from 192.168.1.50, but could be anyone else)
/// char buffer[1024];
/// std::size_t received = 0;
/// TGE::IpAddress sender;
/// unsigned short port;
...
/// \endcode
///
/// \see TGE::Socket, TGE::TcpSocket, TGE::Packet
///
////////////////////////////////////////////////////////////
