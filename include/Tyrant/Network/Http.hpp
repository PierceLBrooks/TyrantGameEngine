...
#include <Tyrant/Network/IpAddress.hpp>
...
///
////////////////////////////////////////////////////////////
class TGE_API Http : NonCopyable
{
public :
...
/// \ingroup network
///
/// TGE::Http is a very simple HTTP client that allows you
...
/// \li TGE::Http::Request
/// \li TGE::Http::Response
/// \li TGE::Http
///
/// TGE::Http::Request builds the request that will be
...
///
/// TGE::Http::Response parse the response from the web server
/// and provides getters to read them. The response contains:
/// \li a status code
/// \li header fields (that may be answers to the ones that you requested)
/// \li a body, which contains the contents of the requested resource
///
/// TGE::Http provides a simple function, SendRequest, to send a
/// TGE::Http::Request and return the corresponding TGE::Http::Response
/// from the server.
///
/// Usage example:
/// \code
...
/// TGE::Http http;
///
/// // We'll work on http://www.TGE-dev.org
/// http.setHost("http://www.TGE-dev.org");
///
/// // Prepare a request to get the 'features.php' page
/// TGE::Http::Request request("features.php");
///
/// // Send the request
/// TGE::Http::Response response = http.sendRequest(request);
///
/// // Check the status code and display the result
/// TGE::Http::Response::Status status = response.getStatus();
/// if (status == TGE::Http::Response::Ok)
/// {
