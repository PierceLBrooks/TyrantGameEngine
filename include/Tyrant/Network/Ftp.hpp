...
public :
    ...
    ///
    ////////////////////////////////////////////////////////////
    class TGE_API DirectoryResponse : public Response
    {
    public :
    ...
    ///        filename lisiting
    ////////////////////////////////////////////////////////////
    class TGE_API ListingResponse : public Response
    {
    public :
    ...
    /// functions in the TGE::Ftp class, this method can be used
...
/// \ingroup network
///
/// TGE::Ftp is a very simple FTP client that allows you
...
/// TGE::Ftp::Response to provide this data. The most often used
...
/// TGE::Ftp::Response response = ftp.connect("ftp://ftp.myserver.com");
/// if (response.isOk())
...
/// TGE::Ftp::DirectoryResponse directory = ftp.getWorkingDirectory();
/// if (directory.isOk())
...
/// response = ftp.upload("local-path/file.txt", "files", TGE::Ftp::Ascii);
/// if (response.isOk())
