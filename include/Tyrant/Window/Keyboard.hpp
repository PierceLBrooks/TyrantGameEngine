...
#ifndef TGE_KEYBOARD_HPP
#define TGE_KEYBOARD_HPP
...
/// \ingroup window
///
/// TGE::Keyboard provides an interface to the state of the
...
/// TGE::Keyboard can retrieve the state of a key at any time
...
/// Usage example:
/// \code
/// if (TGE::Keyboard::isKeyPressed(TGE::Keyboard::Left))
/// {
///     // move left...
/// }
/// else if (TGE::Keyboard::isKeyPressed(TGE::Keyboard::Right))
/// {
///     // move right...
/// }
/// else if (TGE::Keyboard::isKeyPressed(TGE::Keyboard::Escape))
/// {
///     // quit...
/// }
/// \endcode
///
/// \see TGE::Joystick, TGE::Mouse
///
////////////////////////////////////////////////////////////
