...
#ifndef TGE_WINDOW_HPP
#define TGE_WINDOW_HPP
...
///
////////////////////////////////////////////////////////////
class TGE_API Window : GlResource, NonCopyable
{
public :
    ...
    ///
    /// After calling this function, the TGE::Window instance remains
    ...
    /// TGE will try to match the given limit as much as it can,
    /// but since it internally uses TGE::sleep, whose precision
    ...
    ///
    /// The type of the returned handle is TGE::WindowHandle,
    /// which is a typedef to the handle type defined by the OS.
    /// You shouldn't need to use this function, unless you have
    /// very specific stuff to implement that TGE doesn't support,
    /// or implement a temporary workaround until a bug is fixed.
    /// The type is \a HWND on Windows, \a %Window on Linux
...
/// \ingroup window
///
/// TGE::Window is the main class of the Window module. It defines
/// an OS window that is able to receive an OpenGL rendering.
///
/// A TGE::Window can create its own new window, or be embedded into
...
///
/// The TGE::Window class provides a simple interface for manipulating
...
/// OpenGL context attached to the window, with the TGE::ContextSettings
...
/// TGE::Window window(TGE::VideoMode(800, 600), "TGE window");
///
