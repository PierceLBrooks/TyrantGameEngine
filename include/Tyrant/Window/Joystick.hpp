...
#ifndef TGE_JOYSTICK_HPP
#define TGE_JOYSTICK_HPP
...
public :
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Axes supported by TGE joysticks
    ///
    ////////////////////////////////////////////////////////////
    enum Axis
    {
    ...
    struct Identification
    {
        ...
        TGE::String   name;      ///< Name of the joystick
    ...
    ///
    /// This function is used internally by TGE, so you normally
...
/// \ingroup window
///
/// TGE::Joystick provides an interface to the state of the
...
/// and JoystickButtonReleased events, TGE::Joystick can retrieve the
...
///
/// TGE supports:
/// \li 8 joysticks (TGE::Joystick::Count)
/// \li 32 buttons per joystick (TGE::Joystick::ButtonCount)
/// \li 8 axes per joystick (TGE::Joystick::AxisCount)
///
...
/// you must call TGE::Joystick::update explicitely.
///
/// Usage example:
/// \code
/// // Is joystick #0 connected?
/// bool connected = TGE::Joystick::isConnected(0);
///
/// // How many buttons does joystick #0 support?
/// unsigned int buttons = TGE::Joystick::getButtonCount(0);
///
/// // Does joystick #0 define a X axis?
/// bool hasX = TGE::Joystick::hasAxis(0, TGE::Joystick::X);
///
/// // Is button #2 pressed on joystick #0?
/// bool pressed = TGE::Joystick::isButtonPressed(0, 2);
///
/// // What's the current position of the Y axis on joystick #0?
/// float position = TGE::Joystick::getAxisPosition(0, TGE::Joystick::Y);
/// \endcode
///
/// \see TGE::Keyboard, TGE::Mouse
///
////////////////////////////////////////////////////////////
