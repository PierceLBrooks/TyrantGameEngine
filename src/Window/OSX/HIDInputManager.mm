...
m_manager(0)
{
    ...
    if (m_layoutData == 0)
    {
        TGE::Log() << "Cannot get the keyboard layout" << std::endl;
        freeUp();
        return;
    }
    ...
    {
        TGE::Log() << "Error when opening the HID manager" << std::endl;
        freeUp();
        return;
    }
...
void HIDInputManager::initializeKeyboard()
{
    ...
    // the associate IOHIDElementRef with a TGE::Keyboard::Key in ~constant~ time.
...
void HIDInputManager::initializeMouse()
{
    ...
    // the associate IOHIDElementRef with a TGE::Mouse::Button in ~constant~ time.
...
void HIDInputManager::loadKeyboard(IOHIDDeviceRef keyboard)
{
    ...
    if (keys == NULL)
    {
        TGE::Log() << "We got a keyboard without any keys (1)" << std::endl;
        return;
    }
    ...
    if (keysCount == 0)
    {
        TGE::Log() << "We got a keyboard without any keys (2)" << std::endl;
        CFRelease(keys);
        return;
    }
...
void HIDInputManager::loadMouse(IOHIDDeviceRef mouse)
{
    ...
    if (buttons == NULL)
    {
        TGE::Log() << "We got a mouse without any buttons (1)" << std::endl;
        return;
    }
    ...
    if (buttonCount == 0)
    {
        TGE::Log() << "We got a mouse without any buttons (2)" << std::endl;
        CFRelease(buttons);
        return;
    }
...
void HIDInputManager::loadKey(IOHIDElementRef key)
{
    ...
    if (error == noErr)
    {
        ...
        // The corresponding TGE key code
        ...
        if (code != Keyboard::Unknown)
        {
            ...
            // corresponding TGE::Keyboard::Key to one IOHIDElementRef
    ...
    {
        TGE::Log() << "Cannot translate the virtual key code, error : "
                  << error
                  << std::endl;
    }
}
...
bool HIDInputManager::isPressed(IOHIDElements& elements)
{
    if (!m_isValid)
    {
        TGE::Log() << "HIDInputManager is invalid." << std::endl;
        return false;
    }
...
Keyboard::Key HIDInputManager::localizedKeys(UniChar ch)
{
    ...
    {
        case 'a':
        case 'A':                   return TGE::Keyboard::A;

        case 'b':
        case 'B':                   return TGE::Keyboard::B;

        case 'c':
        case 'C':                   return TGE::Keyboard::C;

        case 'd':
        case 'D':                   return TGE::Keyboard::D;

        case 'e':
        case 'E':                   return TGE::Keyboard::E;

        case 'f':
        case 'F':                   return TGE::Keyboard::F;

        case 'g':
        case 'G':                   return TGE::Keyboard::G;

        case 'h':
        case 'H':                   return TGE::Keyboard::H;

        case 'i':
        case 'I':                   return TGE::Keyboard::I;

        case 'j':
        case 'J':                   return TGE::Keyboard::J;

        case 'k':
        case 'K':                   return TGE::Keyboard::K;

        case 'l':
        case 'L':                   return TGE::Keyboard::L;

        case 'm':
        case 'M':                   return TGE::Keyboard::M;

        case 'n':
        case 'N':                   return TGE::Keyboard::N;

        case 'o':
        case 'O':                   return TGE::Keyboard::O;

        case 'p':
        case 'P':                   return TGE::Keyboard::P;

        case 'q':
        case 'Q':                   return TGE::Keyboard::Q;

        case 'r':
        case 'R':                   return TGE::Keyboard::R;

        case 's':
        case 'S':                   return TGE::Keyboard::S;

        case 't':
        case 'T':                   return TGE::Keyboard::T;

        case 'u':
        case 'U':                   return TGE::Keyboard::U;

        case 'v':
        case 'V':                   return TGE::Keyboard::V;

        case 'w':
        case 'W':                   return TGE::Keyboard::W;

        case 'x':
        case 'X':                   return TGE::Keyboard::X;

        case 'y':
        case 'Y':                   return TGE::Keyboard::Y;

        case 'z':
        case 'Z':                   return TGE::Keyboard::Z;

            // The key is not 'localized'.
        default:                    return TGE::Keyboard::Unknown;
    }
}
...
Keyboard::Key HIDInputManager::nonLocalizedKeys(UniChar virtualKeycode)
{
    ...
    // Some TGE::Keyboard::Key are present twice.
    switch (virtualKeycode)
    {
            // These cases should not be used but anyway...
        case 0x00:                      return TGE::Keyboard::A;
        case 0x0b:                      return TGE::Keyboard::B;
        case 0x08:                      return TGE::Keyboard::C;
        case 0x02:                      return TGE::Keyboard::D;
        case 0x0e:                      return TGE::Keyboard::E;
        case 0x03:                      return TGE::Keyboard::F;
        case 0x05:                      return TGE::Keyboard::G;
        case 0x04:                      return TGE::Keyboard::H;
        case 0x22:                      return TGE::Keyboard::I;
        case 0x26:                      return TGE::Keyboard::J;
        case 0x28:                      return TGE::Keyboard::K;
        case 0x25:                      return TGE::Keyboard::L;
        case 0x2e:                      return TGE::Keyboard::M;
        case 0x2d:                      return TGE::Keyboard::N;
        case 0x1f:                      return TGE::Keyboard::O;
        case 0x23:                      return TGE::Keyboard::P;
        case 0x0c:                      return TGE::Keyboard::Q;
        case 0x0f:                      return TGE::Keyboard::R;
        case 0x01:                      return TGE::Keyboard::S;
        case 0x11:                      return TGE::Keyboard::T;
        case 0x20:                      return TGE::Keyboard::U;
        case 0x09:                      return TGE::Keyboard::V;
        case 0x0d:                      return TGE::Keyboard::W;
        case 0x07:                      return TGE::Keyboard::X;
        case 0x10:                      return TGE::Keyboard::Y;
        case 0x06:                      return TGE::Keyboard::Z;

            // These cases should not be used but anyway...
        case 0x1d:                      return TGE::Keyboard::Num0;
        case 0x12:                      return TGE::Keyboard::Num1;
        case 0x13:                      return TGE::Keyboard::Num2;
        case 0x14:                      return TGE::Keyboard::Num3;
        case 0x15:                      return TGE::Keyboard::Num4;
        case 0x17:                      return TGE::Keyboard::Num5;
        case 0x16:                      return TGE::Keyboard::Num6;
        case 0x1a:                      return TGE::Keyboard::Num7;
        case 0x1c:                      return TGE::Keyboard::Num8;
        case 0x19:                      return TGE::Keyboard::Num9;

        case 0x35:                      return TGE::Keyboard::Escape;

            // Modifier keys : never happen with keyDown/keyUp methods (?)
        case 0x3b:                      return TGE::Keyboard::LControl;
        case 0x38:                      return TGE::Keyboard::LShift;
        case 0x3a:                      return TGE::Keyboard::LAlt;
        case 0x37:                      return TGE::Keyboard::LSystem;
        case 0x3e:                      return TGE::Keyboard::RControl;
        case 0x3c:                      return TGE::Keyboard::RShift;
        case 0x3d:                      return TGE::Keyboard::RAlt;
        case 0x36:                      return TGE::Keyboard::RSystem;

        case 0x7f:                      return TGE::Keyboard::Menu;
        case NSMenuFunctionKey:         return TGE::Keyboard::Menu;

        case 0x21:                      return TGE::Keyboard::LBracket;
        case 0x1e:                      return TGE::Keyboard::RBracket;
        case 0x29:                      return TGE::Keyboard::SemiColon;
        case 0x2b:                      return TGE::Keyboard::Comma;
        case 0x41: /* keypad         */ return TGE::Keyboard::Period;
        case 0x2f: /* keyboard       */ return TGE::Keyboard::Period;
        case 0x27:                      return TGE::Keyboard::Quote;
        case 0x2c:                      return TGE::Keyboard::Slash;
        case 0x2a:                      return TGE::Keyboard::BackSlash;

#warning TGE::Keyboard::Tilde might be in conflict with some other key.
            // 0x0a is for "Non-US Backslash" according to HID Calibrator,
            // a sample provided by Apple.
        case 0x0a:                      return TGE::Keyboard::Tilde;

        case 0x51: /* keypad         */ return TGE::Keyboard::Equal;
        case 0x18: /* keyboard       */ return TGE::Keyboard::Equal;
        case 0x32:                      return TGE::Keyboard::Dash;
        case 0x31:                      return TGE::Keyboard::Space;
        case 0x4c: /* keypad         */ return TGE::Keyboard::Return;
        case 0x24: /* keyboard       */ return TGE::Keyboard::Return;
        case 0x33:                      return TGE::Keyboard::BackSpace;
        case 0x30:                      return TGE::Keyboard::Tab;

            // Duplicates (see next §).
        case 0x74:                      return TGE::Keyboard::PageUp;
        case 0x79:                      return TGE::Keyboard::PageDown;
        case 0x77:                      return TGE::Keyboard::End;
        case 0x73:                      return TGE::Keyboard::Home;

        case NSPageUpFunctionKey:       return TGE::Keyboard::PageUp;
        case NSPageDownFunctionKey:     return TGE::Keyboard::PageDown;
        case NSEndFunctionKey:          return TGE::Keyboard::End;
        case NSHomeFunctionKey:         return TGE::Keyboard::Home;

        case 0x72:                      return TGE::Keyboard::Insert;
        case NSInsertFunctionKey:       return TGE::Keyboard::Insert;
        case 0x75:                      return TGE::Keyboard::Delete;
        case NSDeleteFunctionKey:       return TGE::Keyboard::Delete;

        case 0x45:                      return TGE::Keyboard::Add;
        case 0x4e:                      return TGE::Keyboard::Subtract;
        case 0x43:                      return TGE::Keyboard::Multiply;
        case 0x4b:                      return TGE::Keyboard::Divide;

            // Duplicates (see next §).
        case 0x7b:                      return TGE::Keyboard::Left;
        case 0x7c:                      return TGE::Keyboard::Right;
        case 0x7e:                      return TGE::Keyboard::Up;
        case 0x7d:                      return TGE::Keyboard::Down;

        case NSLeftArrowFunctionKey:    return TGE::Keyboard::Left;
        case NSRightArrowFunctionKey:   return TGE::Keyboard::Right;
        case NSUpArrowFunctionKey:      return TGE::Keyboard::Up;
        case NSDownArrowFunctionKey:    return TGE::Keyboard::Down;

        case 0x52:                      return TGE::Keyboard::Numpad0;
        case 0x53:                      return TGE::Keyboard::Numpad1;
        case 0x54:                      return TGE::Keyboard::Numpad2;
        case 0x55:                      return TGE::Keyboard::Numpad3;
        case 0x56:                      return TGE::Keyboard::Numpad4;
        case 0x57:                      return TGE::Keyboard::Numpad5;
        case 0x58:                      return TGE::Keyboard::Numpad6;
        case 0x59:                      return TGE::Keyboard::Numpad7;
        case 0x5b:                      return TGE::Keyboard::Numpad8;
        case 0x5c:                      return TGE::Keyboard::Numpad9;

            // Duplicates (see next §).
        case 0x7a:                      return TGE::Keyboard::F1;
        case 0x78:                      return TGE::Keyboard::F2;
        case 0x63:                      return TGE::Keyboard::F3;
        case 0x76:                      return TGE::Keyboard::F4;
        case 0x60:                      return TGE::Keyboard::F5;
        case 0x61:                      return TGE::Keyboard::F6;
        case 0x62:                      return TGE::Keyboard::F7;
        case 0x64:                      return TGE::Keyboard::F8;
        case 0x65:                      return TGE::Keyboard::F9;
        case 0x6d:                      return TGE::Keyboard::F10;
        case 0x67:                      return TGE::Keyboard::F11;
        case 0x6f:                      return TGE::Keyboard::F12;
        case 0x69:                      return TGE::Keyboard::F13;
        case 0x6b:                      return TGE::Keyboard::F14;
        case 0x71:                      return TGE::Keyboard::F15;

        case NSF1FunctionKey:           return TGE::Keyboard::F1;
        case NSF2FunctionKey:           return TGE::Keyboard::F2;
        case NSF3FunctionKey:           return TGE::Keyboard::F3;
        case NSF4FunctionKey:           return TGE::Keyboard::F4;
        case NSF5FunctionKey:           return TGE::Keyboard::F5;
        case NSF6FunctionKey:           return TGE::Keyboard::F6;
        case NSF7FunctionKey:           return TGE::Keyboard::F7;
        case NSF8FunctionKey:           return TGE::Keyboard::F8;
        case NSF9FunctionKey:           return TGE::Keyboard::F9;
        case NSF10FunctionKey:          return TGE::Keyboard::F10;
        case NSF11FunctionKey:          return TGE::Keyboard::F11;
        case NSF12FunctionKey:          return TGE::Keyboard::F12;
        case NSF13FunctionKey:          return TGE::Keyboard::F13;
        case NSF14FunctionKey:          return TGE::Keyboard::F14;
        case NSF15FunctionKey:          return TGE::Keyboard::F15;

        case NSPauseFunctionKey:        return TGE::Keyboard::Pause;
