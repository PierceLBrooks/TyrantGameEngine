...
-(void)keyDown:(NSEvent*)theEvent
{
    ...
    // that contains a TGE rendering area. Doing so will prevent a system
...
-(void)performClose:(id)sender
{
    ...
    //
    // The last paragraph is problematic for TGE fullscreen window since they don't have
    ...
    // error: no visible @interface for 'TGEWindow' declares the selector 'windowShouldClose:'
