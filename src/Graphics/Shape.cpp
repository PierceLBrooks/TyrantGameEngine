...
namespace
{
    ...
    TGE::Vector2f computeNormal(const TGE::Vector2f& p1, const TGE::Vector2f& p2)
    {
        TGE::Vector2f normal(p1.y - p2.y, p2.x - p1.x);
    ...
    float dotProduct(const TGE::Vector2f& p1, const TGE::Vector2f& p2)
    {
